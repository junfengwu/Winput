<?php namespace Weboap\Winput\Libs\Html;


// developed by padraic @ https://github.com/padraic/SecurityMultiTool

use Exception;

class Sanitizer extends Abstracts\AbstractOptions implements Interfaces\OptionsInterface
{
